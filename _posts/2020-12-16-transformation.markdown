...
This is known as the convolution of $$P_{X}$$ and $$P_{Y}$$ or vice versa. $$P_{X}(x)$$ can be thought of as the input function at $$X = x$$ and $$P_{Y}(y)$$ as the unit impulse function shifted to $$z - x$$.
